...
[screenkey](https://gitlab.com/screenkey/screenkey) is a python app which shows key presses in an overlay on the screen. Nice for live coding to show off key combinations and shortcuts.
